...
if(isset($_POST['add_to_cart'])){
   ...
   if($fetch_stock['stock'] < $product_quantity){
      // If there is not enough stock, display an error message
      $message[] = 'Not enough stock available!';
   } else {
      // Proceed with adding to cart if there is enough stock
      ...
      if(mysqli_num_rows($check_cart_numbers) > 0){
         ...
         $new_stock = $fetch_stock['stock'] - $product_quantity;
...
<section class="products">
   ...
   <div class="box-container">
     ...
     <form action="" method="post" class="box">
      ...
      <div class="stock">Available:<?php echo $fetch_products['stock'];?></div>
      ...
      <?php
         ...
         <input type="number" min="1" class="qty" disabled>
